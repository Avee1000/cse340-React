import "../styles/minFunctions.css" 
import { useEffect, useState } from "react";
export function UpButtonHideShow() {
  ...
  useEffect(() => {
    ...
    return (
        isVisible && (<div className="upButton position-relative w-100">
            <div onClick={scrollToTop} className="upButtonContainer position-fixed d-inline-block m-3">
